...
public class DisableCraftingTableStatusEffect extends AnnoyingStatusEffect implements HandicapStatusEffectTag, NightMareStatusEffectTag {
    public DisableCraftingTableStatusEffect() {
        super(); // 显示的颜色
    }
