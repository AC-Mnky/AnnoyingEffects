...
public class HeavinessStatusEffect extends AnnoyingStatusEffect implements AdaptableStatusEffectTag, NightMareStatusEffectTag {
    public HeavinessStatusEffect() {
        super(); // 显示的颜色
    }
