...
| 消失诅咒（Curse of vanishing） | 你死亡时物品栏中五分之一物品会消失。                 | Subtle | 20/100                  | ✅       | ✅材质丢失*4  |
...
| 旋转（Spin）       | 你会一直逆时针旋转。                                       | SevereHandicap, Unconfortable | 15/600                | ✅ | ✅🌀       |
...
| 旧世界的记忆（Memories of the old world / WaterFilling） | 持续在半径4空气中生成水源。破坏附近的门和类似的东西。移除潮涌能量。 | Damage, Adaptable, Terrachanging | 触水时间÷5/15（仅触水时间>75） | ✅ | ✅水（方块）    |
